		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAndRefinementAccess().getSourceAssignment_3_0_1(), "rule__AndRefinement__SourceAssignment_3_0_1");
					put(grammarAccess.getAndRefinementAccess().getDestAssignment_3_1_2(), "rule__AndRefinement__DestAssignment_3_1_2");
					put(grammarAccess.getAndRefinementAccess().getDestAssignment_3_1_3_1(), "rule__AndRefinement__DestAssignment_3_1_3_1");
					put(grammarAccess.getOrRefinementAccess().getNameAssignment_1(), "rule__OrRefinement__NameAssignment_1");
					put(grammarAccess.getOrRefinementAccess().getSourceAssignment_3_0_1(), "rule__OrRefinement__SourceAssignment_3_0_1");
					put(grammarAccess.getOrRefinementAccess().getDestAssignment_3_1_2(), "rule__OrRefinement__DestAssignment_3_1_2");
					put(grammarAccess.getOrRefinementAccess().getDestAssignment_3_1_3_1(), "rule__OrRefinement__DestAssignment_3_1_3_1");
