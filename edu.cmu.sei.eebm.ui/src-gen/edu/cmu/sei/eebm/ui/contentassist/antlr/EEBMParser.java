	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getRoadmapAccess().getTrajectoriesAlternatives_3_0(), "rule__Roadmap__TrajectoriesAlternatives_3_0");
					...
					put(grammarAccess.getOptionAccess().getGroup_4_2(), "rule__Option__Group_4_2__0");
					put(grammarAccess.getOptionAccess().getGroup_4_4(), "rule__Option__Group_4_4__0");
					put(grammarAccess.getOptionAccess().getGroup_4_5(), "rule__Option__Group_4_5__0");
					put(grammarAccess.getOptionAccess().getGroup_4_6(), "rule__Option__Group_4_6__0");
					put(grammarAccess.getOptionAccess().getGroup_4_7(), "rule__Option__Group_4_7__0");
					...
					put(grammarAccess.getDecisionAccess().getGroup_3_0(), "rule__Decision__Group_3_0__0");
					put(grammarAccess.getDecisionAccess().getGroup_3_1(), "rule__Decision__Group_3_1__0");
					put(grammarAccess.getDecisionAccess().getGroup_3_2(), "rule__Decision__Group_3_2__0");
					put(grammarAccess.getDecisionAccess().getGroup_3_3(), "rule__Decision__Group_3_3__0");
					put(grammarAccess.getDecisionAccess().getGroup_3_4(), "rule__Decision__Group_3_4__0");
					put(grammarAccess.getDecisionAccess().getGroup_3_4_1(), "rule__Decision__Group_3_4_1__0");
					put(grammarAccess.getDecisionAccess().getGroup_3_4_1_2(), "rule__Decision__Group_3_4_1_2__0");
					...
					put(grammarAccess.getRoadmapAccess().getPeopleAssignment_2(), "rule__Roadmap__PeopleAssignment_2");
					put(grammarAccess.getRoadmapAccess().getTrajectoriesAssignment_3(), "rule__Roadmap__TrajectoriesAssignment_3");
					put(grammarAccess.getPathAccess().getNameAssignment_0(), "rule__Path__NameAssignment_0");
					put(grammarAccess.getPathAccess().getPathAssignment_1(), "rule__Path__PathAssignment_1");
					...
					put(grammarAccess.getOptionAccess().getRefinesReferenceAssignment_4_1_1(), "rule__Option__RefinesReferenceAssignment_4_1_1");
					put(grammarAccess.getOptionAccess().getConflictsReferenceAssignment_4_2_1(), "rule__Option__ConflictsReferenceAssignment_4_2_1");
					put(grammarAccess.getOptionAccess().getPriorityAssignment_4_3_1(), "rule__Option__PriorityAssignment_4_3_1");
					put(grammarAccess.getOptionAccess().getTimeAssignment_4_4_1(), "rule__Option__TimeAssignment_4_4_1");
					put(grammarAccess.getOptionAccess().getCostAssignment_4_5_1(), "rule__Option__CostAssignment_4_5_1");
					put(grammarAccess.getOptionAccess().getDateAssignment_4_6_1(), "rule__Option__DateAssignment_4_6_1");
					put(grammarAccess.getOptionAccess().getCodAssignment_4_7_1(), "rule__Option__CodAssignment_4_7_1");
					...
					put(grammarAccess.getDecisionAccess().getRationaleAssignment_3_0_1(), "rule__Decision__RationaleAssignment_3_0_1");
					put(grammarAccess.getDecisionAccess().getResponsibleAssignment_3_1_1(), "rule__Decision__ResponsibleAssignment_3_1_1");
					put(grammarAccess.getDecisionAccess().getResponse_measureAssignment_3_2_1(), "rule__Decision__Response_measureAssignment_3_2_1");
					put(grammarAccess.getDecisionAccess().getDueAssignment_3_3_1(), "rule__Decision__DueAssignment_3_3_1");
					put(grammarAccess.getDecisionAccess().getOptionsAssignment_3_4_1_1(), "rule__Decision__OptionsAssignment_3_4_1_1");
					put(grammarAccess.getDecisionAccess().getOptionsAssignment_3_4_1_2_1(), "rule__Decision__OptionsAssignment_3_4_1_2_1");
					...
					put(grammarAccess.getGoalAccess().getDescriptionAssignment_0_5(), "rule__Goal__DescriptionAssignment_0_5");
					put(grammarAccess.getGoalAccess().getRationaleAssignment_1(), "rule__Goal__RationaleAssignment_1");
					put(grammarAccess.getGoalAccess().getDocReferenceAssignment_2_0_2(), "rule__Goal__DocReferenceAssignment_2_0_2");
					put(grammarAccess.getDescriptionAccess().getDescriptionAssignment_1(), "rule__Description__DescriptionAssignment_1");
					put(grammarAccess.getDescriptionElementAccess().getTextAssignment(), "rule__DescriptionElement__TextAssignment");
					...
					put(grammarAccess.getOptionAccess().getUnorderedGroup_4_3(), "rule__Option__UnorderedGroup_4_3");
					put(grammarAccess.getParticipantAccess().getUnorderedGroup(), "rule__Participant__UnorderedGroup");
					put(grammarAccess.getDecisionAccess().getUnorderedGroup_3(), "rule__Decision__UnorderedGroup_3");
