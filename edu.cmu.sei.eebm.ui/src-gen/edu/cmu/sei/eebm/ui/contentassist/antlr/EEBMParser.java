		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGoalAccess().getDocReferenceAssignment_2_2(), "rule__Goal__DocReferenceAssignment_2_2");
					put(grammarAccess.getGoalAccess().getIssuesAssignment_3_0_1(), "rule__Goal__IssuesAssignment_3_0_1");
